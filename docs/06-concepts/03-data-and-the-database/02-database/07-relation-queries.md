...
When working with large datasets, it's often necessary to [filter](./filtering) and [sort](./sorting) the records to retrieve the most relevant data. Serverpod offers methods to refine the included list of related objects:
