...
:::info
An anonymous account is its own auth user. To move its data to an account from another provider, merge the accounts. See [Merging accounts](../../working-with-users#merging-accounts).
:::
