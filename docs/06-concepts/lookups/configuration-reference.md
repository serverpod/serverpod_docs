...
| SERVERPOD_INSIGHTS_SERVER_ENABLE_DATABASE_ACCESS | insightsServer.enableDatabaseAccess | false     | Whether the Insights server serves the database access endpoints (browse tables, run queries)                                                                                                                |
