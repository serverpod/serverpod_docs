...
:::info
The usage of Vector fields requires the pgvector PostgreSQL extension to be installed, which comes by default on new Serverpod projects. To upgrade an existing project, see the [Upgrade to pgvector](../../11-upgrading/02-archive/05-upgrade-to-pgvector.md) guide.
:::
