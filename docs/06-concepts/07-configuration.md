...
| SERVERPOD_CHECK_BROKEN_FUTURE_CALLS      | futureCall.checkBrokenFutureCalls    | -         | Enables or disables the check for broken future calls on startup.                                                                                     |
| SERVERPOD_DELETE_BROKEN_FUTURE_CALLS     | futureCall.deleteBrokenFutureCalls   | false     | Enables or disables the deletion of broken future calls on startup.                                                                                   |
