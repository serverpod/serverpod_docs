...
| SERVERPOD_FUTURE_CALL_CHECK_BROKEN_CALLS  | futureCall.checkBrokenCalls          | -         | Enables or disables the check for broken future calls on startup.                                                                                     |
| SERVERPOD_FUTURE_CALL_DELETE_BROKEN_CALLS | futureCall.deleteBrokenCalls         | false     | Enables or disables the deletion of broken future calls on startup.                                                                                   |
