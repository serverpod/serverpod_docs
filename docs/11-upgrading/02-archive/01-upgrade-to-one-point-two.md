...
The keyword `parent` has been moved and should be placed inside the new `relation` keyword, see the section on [relations](../../concepts/data-and-the-database/database/relations/one-to-one) for the full new feature set.
