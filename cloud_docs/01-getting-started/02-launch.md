...
- A Serverpod project on your machine. See Serverpod's [framework documentation](https://docs.serverpod.dev/) to create one.
...
- **Project ID.** scloud suggests a default from your pubspec name (for example, `my-app`). Press Enter to accept, or type a different ID. The project ID becomes part of your default URLs (`<project-id>.serverpod.space`).
