...
Alternatively, set `appleKey` using an environment variable to skip indentation issues. See [Using Environment Variables](./02-configuration#using-environment-variables).
